...
from huobi_trace.demo.HuobiDMService import HuobiDM
from pprint import pprint

URL = "https://api.hbdm.com"

####  input your access_key and secret_key below:
ACCESS_KEY = '4e45afaa-11e81c06-399e13ae-7yngd7gh5g'
SECRET_KEY = 'd5d6cd20-dd8b30c3-eaca5a98-7b620'
...
print (u' 获取K线数据 ')
pprint (dm.get_contract_kline(symbol='BTC_BCH', period='1min', size=20))
